        ...
        <main className="flex-1 overflow-hidden flex flex-col p-8 w-full">
          {activeTab === 'tickets' ? (
                ...
                <table className="w-full text-left border-collapse">
                  <thead className="sticky top-0 z-20">
                    <tr className="bg-[#F9FAFB] text-[#667085] text-[12px] font-semibold border-b border-[#EAECF0]">
                      ...
                      <th className="py-3 px-6 uppercase tracking-wider">Machine</th>
                  ...
                  <tbody className="divide-y divide-[#EAECF0]">
                    {filteredTickets.map((ticket, idx) => (
                      <tr 
                        ...
                        onClick={() => onViewDetail(ticket.ticketId)}
                      >
                        <td className="py-4 px-6 text-sm font-mono font-bold text-[#101828]">
                           <span className="text-[#007a8c] group-hover:underline">{ticket.ticketId}</span>
                        </td>
            ...
            <div className="flex flex-col items-center justify-center h-[60vh] text-slate-400">
               ...
               <p className="max-w-sm text-center font-medium">Ce module est en cours d'optimisation.</p>
               {activeTab === 'settings' && (
                  <button onClick={exportDatabase} className="mt-8 px-6 py-2.5 bg-white border border-[#D0D5DD] text-[#344054] hover:bg-[#F9FAFB] font-semibold text-sm rounded-lg shadow-sm">
